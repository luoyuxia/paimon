...
/**
 * Factory interface for creating {@link StreamStore} instances.
 *
...
public interface StreamingStoreFactory extends Factory {
    ...
    /**
     * Creates a {@link StreamStore} instance with the given options.
     *
     ...
     * @return A new {@link StreamStore} instance
     */
    StreamStore createStreamingStore(Options options);
}
